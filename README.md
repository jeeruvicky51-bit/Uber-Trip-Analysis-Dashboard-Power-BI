...
This project focuses on analyzing Uber trip data using Power BI to gain insights into booking trends, revenue generation, trip distance, and ride efficiency.
The dashboard helps stakeholders make data-driven decisions to optimize pricing models, driver allocation, and customer satisfaction.

🎯 Objective

To design and develop a comprehensive analytics dashboard that provides a clear picture of Uber’s operations through interactive data visualizations and key performance indicators (KPIs).
...
✅ Dynamic KPI Selector (Disconnected Table)
...
✅ Bookmarks for user navigation and data explanation
✅ “Clear Filters” and “Export Data” buttons for user experience
